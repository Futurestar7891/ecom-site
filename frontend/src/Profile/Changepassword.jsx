    ...
    <div className="changepasswordmaindiv">
      <div className="changepasswordcontainer">
        ...
        <form action="" onSubmit={changepassword}>
            ...
            <input type="text" name="Oldpassword" id="" value={values.Oldpassword}  onChange={handleInput} placeholder="Enter Old Password" />
           
            <input type="text" name="Newpassword" id="" value={values.Newpassword} onChange={handleInput} placeholder="Enter New Password"/>
            
            <input type="text" name="Confirmpassword" id="" value={values.Confirmpassword} onChange={handleInput} placeholder="Confirtm New Password" />
